...
export default function Internships() {
  ...
  const internships = [
    ...
    { id: 2, title: 'Backend Developer Intern', tech: 'Node.js, Java, SQL', type: 'Remote', duration: '3 Months', stipend: 'Performance-based', img: img10, desc: 'Design backend database schemas, build REST controllers, and integrate microservices routing.' },
    { id: 3, title: 'Data Analytics Intern', tech: 'Python, SQL, Power BI', type: 'Remote', duration: '3 Months', stipend: 'Performance-based', img: img5, desc: 'Analyze structured databases, construct custom query pipelines, and build interactive Power BI charts for system metrics reporting.' },
    { id: 4, title: 'DevOps Intern', tech: 'Docker, Kubernetes, CI/CD', type: 'Remote', duration: '3 Months', stipend: 'Performance-based', img: img6, desc: 'Automate build processes, manage containerized deployments, and ensure continuous integration and delivery.' },

    // Hybrid
    { id: 5, title: 'Full Stack Java Intern', tech: 'Java, Spring Boot, React', type: 'Hybrid', duration: '6 Months', stipend: 'Performance-based', img: img7, desc: 'Build scalable fullstack enterprise applications using Java and Spring Boot. Implement robust backend APIs.' },
    { id: 6, title: 'Full Stack Python Intern', tech: 'Python, Django, React', type: 'Hybrid', duration: '6 Months', stipend: 'Performance-based', img: img7, desc: 'Develop end-to-end fullstack applications using Python. Implement user authentication, database models, and RESTful APIs.' },
    { id: 7, title: 'MERN Stack Intern', tech: 'MongoDB, Express, React, Node.js', type: 'Hybrid', duration: '6 Months', stipend: 'Performance-based', img: img7, desc: 'Build modern end-to-end fullstack web applications using the MERN stack. Implement user authentication and real-time features.' },
    { id: 8, title: 'AWS Cloud Computing Intern', tech: 'AWS EC2, S3, Docker', type: 'Hybrid', duration: '4 Months', stipend: 'Performance-based', img: img6, desc: 'Configure cloud architecture on AWS, maintain scalable services, and deploy serverless applications.' },

    // On-site
    { id: 9, title: 'MEAN Stack Intern', tech: 'MongoDB, Express, Angular, Node.js', type: 'On-site', duration: '6 Months', stipend: 'Performance-based', img: img7, desc: 'Develop comprehensive fullstack web solutions using the MEAN stack. Build robust Angular interfaces.' },
    { id: 10, title: 'AI and ML Intern', tech: 'TensorFlow, PyTorch, Python', type: 'On-site', duration: '6 Months', stipend: 'Performance-based', img: img9, desc: 'Train predictive and classification algorithms, impute raw datasets, and deploy machine learning models inside API endpoints.' },
    { id: 11, title: 'Generative AI Intern', tech: 'LLMs, Prompt Engineering, Python', type: 'On-site', duration: '4 Months', stipend: 'Performance-based', img: img9, desc: 'Build cutting-edge generative AI applications using large language models and prompt engineering frameworks.' },
    { id: 12, title: 'Mobile Developer Intern', tech: 'React Native, Flutter, Swift', type: 'On-site', duration: '4 Months', stipend: 'Performance-based', img: img11, desc: 'Develop high-performance mobile applications for Android and iOS using modern cross-platform or native technologies.' }
  ];
